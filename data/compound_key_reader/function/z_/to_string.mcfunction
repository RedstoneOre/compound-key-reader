...
# say haha
#Convert
execute in by_redstoneore:dataswap run data modify block 7 0 7 front_text.messages[0] set value '{"storage":"compound_key_reader:temp","nbt":"ToJsonTxVal"}'
data modify storage compound_key_reader:temp args set value {}
execute in by_redstoneore:dataswap run data modify storage compound_key_reader:temp args.str set from block 7 0 7 front_text.messages[0]
#Result
